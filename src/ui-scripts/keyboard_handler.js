...
(function()
{
  ...
  Actions.prototype = BaseActions;

  new Actions('css-inspector');



})();

// TODO edit mode | default mode ?
// implementation of a specific view
(function()
{

  var Keyhandler = function(id)
  {
  ...
  Keyhandler.prototype = BaseKeyhandler;

  new Keyhandler('css-inspector');

  var EditKeyhandler = function(id)
  {
  ...
  EditKeyhandler.prototype = BaseEditKeyhandler;

  new EditKeyhandler('css-inspector');
