...
cls.LocalStorageData = function()
{
  ...
  this.on_active_tab = function(msg)
  {
  ...
  this._finalize_get_key_value_pairs = function(status, message, rt_id)
  {
    ...
    prop = null, 
    i = 0, 
    storage = (this._rts[rt_id].storage = {});
        ...
        message[OBJECT_LIST][0] && (prop_list = message[OBJECT_LIST][0][PROPERTY_LIST]))
    {
      ...
      {
        storage[prop_list[i][PROPERTY_VALUE]] =
        {
  ...
  this.init = function()
  {
    ...
    window.messages.addListener('active-tab', this.on_active_tab.bind(this));
  }
