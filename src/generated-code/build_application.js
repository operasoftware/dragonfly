...
window.app.builders.UrlPlayer || ( window.app.builders.UrlPlayer = {} );
/**
  * @param {Object} service the service description of the according service on the host side
  */
window.app.builders.UrlPlayer["2.0"] = function(service)
{
  var namespace = cls.UrlPlayer && cls.UrlPlayer["2.0"];
  window.app.helpers.implement_service(namespace);
}
