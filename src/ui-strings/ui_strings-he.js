/* Generated from he.po at Thu Jun 17 16:06:26 2010 */
window.ui_strings || ( window.ui_strings  = {} )
window.ui_strings.lang_code = "he";
...
ui_strings.S_BUTTON_LABEL_CONTINUE="המשך";
...
ui_strings.S_BUTTON_LABEL_SETTINGS="סטטי";
ui_strings.S_BUTTON_LABEL_CLEAR_LOG="Clear Log";
ui_strings.S_BUTTON_LABEL_CLOSE_WINDOW="? לסגור את כל החלונות";
ui_strings.S_BUTTON_TEXT_APPLY="תמיד";
ui_strings.S_BUTTON_CLEAR_REQUEST_LOG="%s הושלמה בקשה אל";
ui_strings.S_LABEL_STATUS_INDICATOR="Status indicator for the browser and the debugger";
ui_strings.S_LABEL_PORT="Port";
ui_strings.S_INPUT_DEFAULT_TEXT_SEARCH="חפש";
ui_strings.S_INPUT_DEFAULT_TEXT_FILTER="חיפוש מהיר";
...
ui_strings.S_INFO_SERVICE_NOT_AVAILABLE="אינו זמין FTP שרת";
...
ui_strings.S_TEXT_ENVIRONMENT_PLATFORM="פלטפורמה";
ui_strings.S_TEXT_ENVIRONMENT_USER_AGENT="--אין פירוט--";
...
ui_strings.S_TEXT_ECMA_SCRIPT_TYPE_INLINE="מקוון";
ui_strings.S_TEXT_ECMA_SCRIPT_TYPE_LINKED="שורה";
ui_strings.S_TEXT_ECMA_SCRIPT_TYPE_UNKNOWN="לא ידוע";
ui_strings.S_TEXT_ECMA_SCRIPT_SCRIPT_ID="תיאור";
...
ui_strings.S_BUTTON_LABEL_HELP="עזרה";
ui_strings.S_SELECT_WINDOW_EMPTY="? לסגור את כל החלונות";
...
ui_strings.S_COLUMN_LABEL_FILE="קובץ";
ui_strings.S_COLUMN_LABEL_LINE="שורה";
ui_strings.S_COLUMN_LABEL_ERROR="שגיאה";
...
ui_strings.S_HTTP_LABEL_PATH="נתיב";
...
ui_strings.M_VIEW_LABEL_STYLES="כותרת";
ui_strings.M_VIEW_LABEL_DOM_ATTR="מאפייני חשבון";
...
ui_strings.M_VIEW_LABEL_ERROR_M2="עזרה";
ui_strings.M_VIEW_LABEL_ERROR_NETWORK="רשת";
...
ui_strings.M_VIEW_LABEL_ERROR_VOICE="גודל";
ui_strings.M_VIEW_LABEL_ERROR_WIDGET="חפש";
...
ui_strings.M_VIEW_LABEL_VIEWS="הצג";
...
ui_strings.M_SETTING_LABEL_GENERAL="כללי";
...
ui_strings.M_VIEW_LABEL_COOKIES="עוגיות";
